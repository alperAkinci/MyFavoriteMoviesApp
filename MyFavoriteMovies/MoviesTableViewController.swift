...
// MARK: MoviesTableViewController: UITableViewController
...
class MoviesTableViewController: UITableViewController {
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        /* 2. Build the URL */        
        let urlString = appDelegate.baseURLSecureString + "movie/top_rated" + appDelegate.escapedParameters(methodParameters)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel!.text = ("⭐ \(movie.voteAverage!)") ?? ("0.0")
        ...
        if let posterPath = movie.posterPath {
            ...
            /* 2. Build the URL */
            let baseURL = NSURL(string: appDelegate.secureBaseImageURLString)!
...
// MARK: - MoviesTableViewController: UISearchBarDelegate
...
extension MoviesTableViewController: UISearchBarDelegate {
    ...
    func searchBar(searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        /* 2. Build the URL */
        let urlString = appDelegate.baseURLSecureString + "search/movie" + appDelegate.escapedParameters(methodParameters)
        let url = NSURL(string: urlString)!
